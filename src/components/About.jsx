...
const About = () => {
    ...
    return (
        <section id="about" className="relative py-20 bg-[#0B1F1A]">
            <BackgroundBlobs />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-[#E5E7EB]/80 leading-relaxed mb-6">
                            I'm <span className="font-semibold text-[#10B981]">Nitish Kumar</span>, a passionate Full Stack Developer
                            specializing in building exceptional digital experiences. Currently pursuing
                            <span className="font-semibold text-[#10B981]"> B.E. in Computer Science Engineering</span> at
                        ...
                        <div className="flex gap-8 justify-center sm:justify-start">
                            <div className="text-center">
                                <h4 className="text-3xl font-bold text-[#10B981] mb-1">6+</h4>
                                <p className="text-sm text-[#E5E7EB]/70 uppercase tracking-wider">Projects</p>
                            </div>
                            <div className="text-center">
                                <h4 className="text-3xl font-bold text-[#10B981] mb-1">4+</h4>
                                <p className="text-sm text-[#E5E7EB]/70 uppercase tracking-wider">Certificates</p>
                            </div>
                            <div className="text-center">
                                <h4 className="text-3xl font-bold text-[#10B981] mb-1">100%</h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {skills.map((skill, index) => (
                            <motion.div
                                key={index}
                                className="p-6 rounded-2xl bg-[#0a1814] border border-[#10B981]/10 shadow-lg hover:border-[#10B981]/30 hover:bg-[#10B981]/5 transition-all duration-300"
                                ...
                                whileHover={{ y: -5 }}
                            >
                                <div className="text-3xl text-[#10B981] mb-4">{skill.icon}</div>
