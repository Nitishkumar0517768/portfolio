...
const EducationCard = ({ education, index }) => {
    return (
        <motion.div
            ...
            className="w-full"
        >
            <div className="relative group flex flex-col md:flex-row gap-6 p-8 rounded-2xl bg-[#0a1814] border border-[#10B981]/10 shadow-lg hover:border-[#10B981]/30 hover:shadow-[#10B981]/20 transition-all duration-300 overflow-hidden">
                {/* Icon Badge */}
                <div className="flex-shrink-0">
                    <div className="w-16 h-16 rounded-xl flex items-center justify-center bg-[#10B981]/10 border border-[#10B981]/20 group-hover:bg-[#10B981]/20 transition-colors">
                        <img
                            src={education.icon}
                ...
                <div className="flex-1 flex flex-col">
                    <div className="flex items-center gap-2 mb-3 text-sm font-medium text-[#10B981] bg-[#10B981]/10 w-fit px-3 py-1 rounded-full border border-[#10B981]/20">
                    ...
                    <div className="flex items-center gap-2 text-[#E5E7EB]/70 mb-4 font-medium">
                        <FaGraduationCap className="text-[#10B981]" />
                        ...
                        <ul className="space-y-2 mt-2">
                            {education.points.map((point, idx) => (
                                <li key={idx} className="flex items-start text-[#E5E7EB]/80 text-sm md:text-base leading-relaxed">
                                    <span className="text-[#10B981] mr-2 mt-1.5">•</span>
                                    <span>{point}</span>
                                </li>
                            ))}
                        </ul>
...
const Education = () => {
    return (
        <section id="education" className="relative py-20 bg-[#0B1F1A]">
            <BackgroundBlobs />
